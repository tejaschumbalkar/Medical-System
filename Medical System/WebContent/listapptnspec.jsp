...
<link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
  ...
  $(document).ready(function() {
    $("#doi").datepicker({ maxDate: new Date(2016,12,31), minDate: 0 , changeMonth: true,  
        changeYear: true});
  });
  </script>
...
<body>
<form:form method="POST" action="list_of_doctors3.html">
	   		<table>
	   		
	   	
	   		 <tr>
			        <td><form:label path="specialization">Enter Specialization :</form:label></td>
