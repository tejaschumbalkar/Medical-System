...
<link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
  ...
  $(document).ready(function() {
    $("#doi").datepicker({maxDate: new Date(2016,12,31), minDate:0, changeMonth: true,changeYear: true});
  });
  </script>
...
<body>
 <br><br>
		<form:form method="POST" action="sugg.html">
	   		<table align="center">
			    <tr>
			        <td><form:label path="patientID"><b>Patient ID :</form:label></td>
			    ...
			    <tr>
			        <td><form:label path="appointmentDate"><b>Appointment Date :</form:label></td>
			        <td><form:input path="appointmentDate" required="required" value="${PatientBean.appointmentDate}"  id="doi"/></td>
			    </tr>
			    <tr>
			    <td>
			    </td>
