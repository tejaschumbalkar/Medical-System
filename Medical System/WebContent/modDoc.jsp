...
<br><br>
	...
	<table align="left" border="1" bgcolor="white">
		...
		<c:forEach items="${ViewAll}" var="view">
			<tr>
			    <td align="center"><a href="edit.html?doctorID=${view.doctorID}" title="Click here to edit doctor details">EDIT   </a> | <a href="delete.html?doctorID=${view.doctorID}" title="Click here to delete doctor"> DELETE</a></td>
