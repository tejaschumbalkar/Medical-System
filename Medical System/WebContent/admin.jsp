...
<div style="width:100%; height:80px; overflow:hidden; margin: 0 auto; background-color:#333">
  ...
  <div style="width:750px; height:80px; margin: 0 auto; overflow:hidden; position:relative">
        ...
        <div id="foo1"><input type="submit" class="styled-button-9" value="Log Out" /> </div>
         ...
         <form action="forgetpassword1.html" method="get">
...
<div style="width:750px; height:450px; overflow:hidden; margin: 0 auto; position:relative; margin-top:35px;">
	...
	<a href="add.html" target="main"><div id="btn1" style="float:left"><b> <p> Add Doctors</p> </div> </a>
    <a href="modify.html" target="main"><div id="btn2" style="float:left"><b> <p> Modify Doctor </p> </div> </a>
    <a href="view.html" target="main"><div id="btn3" style="float:left"><b> <p>View All Doctor </p> </div> </a>
    <a href="suggest.html" target="main"><div id="btn4" style="float:left"><b> <p> Suggest Doctor </p> </div> </a>
    <a href="viewP.html" target="main"><div id="btn5" style="float:left"><b> <p> View Patients</p> </div> </a>
     <a href="help.html" target="main"><div id="btn6" style="float:left"><b> <p> Help </p> </div> </a>
...
$(document).ready(function(){
  ...
  TweenLite.to($("#btn3"),2,{css:{left:40},delay:2, ease:Power2.easeOut});
  TweenLite.to($("#btn4"),2,{css:{left:0},delay:2.5, ease:Power2.easeOut});
  TweenLite.to($("#btn5"),2,{css:{left:20},delay:3, ease:Power2.easeOut});
  TweenLite.to($("#btn6"),2,{css:{left:40},delay:3.5, ease:Power2.easeOut});
  ...
  $("#btn2").click(function(){
	  ...
	  TweenLite.to($("#pagecaption"),1,{css:{top:0}, ease:Power2.easeOut});
	  TweenLite.to($("#caption"),1,{css:{top:90}, ease:Power2.easeOut});
	  $("#pagecaption").text("Modify Doctors");
  ...
  $("#btn4").click(function(){
	  ...
	  TweenLite.to($("#pagecaption"),1,{css:{top:0}, ease:Power2.easeOut});
	  TweenLite.to($("#caption"),1,{css:{top:90}, ease:Power2.easeOut});
	  $("#pagecaption").text("Suggest Doctors");
  ...
  $("#btn5").click(function(){
	  ...
	  TweenLite.to($("#pagecaption"),1,{css:{top:0}, ease:Power2.easeOut});
	  TweenLite.to($("#caption"),1,{css:{top:90}, ease:Power2.easeOut});
	  $("#pagecaption").text("View Patients");
